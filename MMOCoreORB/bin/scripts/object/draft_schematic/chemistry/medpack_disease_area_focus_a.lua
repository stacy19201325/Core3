...
object_draft_schematic_chemistry_medpack_disease_area_focus_a = object_draft_schematic_chemistry_shared_medpack_disease_area_focus_a:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Focus Area Disease Delivery Unit - A",
...
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_disease_area_focus_a, "object/draft_schematic/chemistry/medpack_disease_area_focus_a.iff")
