...
object_draft_schematic_chemistry_medpack_enhance_quickness_a = object_draft_schematic_chemistry_shared_medpack_enhance_quickness_a:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Enhance Quickness Medpack - A",
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_enhance_quickness_a.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_enhance_quickness_a, "object/draft_schematic/chemistry/medpack_enhance_quickness_a.iff")
