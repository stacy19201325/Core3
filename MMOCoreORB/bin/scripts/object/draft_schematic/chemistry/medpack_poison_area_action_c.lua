...
object_draft_schematic_chemistry_medpack_poison_area_action_c = object_draft_schematic_chemistry_shared_medpack_poison_area_action_c:new {
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_poison_area_action_c.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_poison_area_action_c, "object/draft_schematic/chemistry/medpack_poison_area_action_c.iff")
