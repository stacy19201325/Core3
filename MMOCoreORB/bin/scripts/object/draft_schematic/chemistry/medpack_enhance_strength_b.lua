...
object_draft_schematic_chemistry_medpack_enhance_strength_b = object_draft_schematic_chemistry_shared_medpack_enhance_strength_b:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Enhance Strength Medpack - B",
...
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_enhance_strength_b, "object/draft_schematic/chemistry/medpack_enhance_strength_b.iff")
