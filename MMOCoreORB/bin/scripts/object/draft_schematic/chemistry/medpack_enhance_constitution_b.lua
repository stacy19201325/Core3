...
object_draft_schematic_chemistry_medpack_enhance_constitution_b = object_draft_schematic_chemistry_shared_medpack_enhance_constitution_b:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Enhance Constitution Medpack - B",
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_enhance_constitution_b.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_enhance_constitution_b, "object/draft_schematic/chemistry/medpack_enhance_constitution_b.iff")
