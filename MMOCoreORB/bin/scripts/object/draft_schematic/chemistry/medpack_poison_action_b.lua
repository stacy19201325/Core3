...
object_draft_schematic_chemistry_medpack_poison_action_b = object_draft_schematic_chemistry_shared_medpack_poison_action_b:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Action Poison Delivery Unit - B",
	...
	resourceQuantities = {6, 15, 15, 1, 1, 2},
	contribution = {100, 100, 100, 100, 100, 100},

	targetTemplate = "object/tangible/medicine/crafted/medpack_poison_action_b.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_poison_action_b, "object/draft_schematic/chemistry/medpack_poison_action_b.iff")
