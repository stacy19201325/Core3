...
object_draft_schematic_chemistry_medpack_wound_quickness_b = object_draft_schematic_chemistry_shared_medpack_wound_quickness_b:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Quickness Wound Medpack - B",
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_wound_quickness_b.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_wound_quickness_b, "object/draft_schematic/chemistry/medpack_wound_quickness_b.iff")
