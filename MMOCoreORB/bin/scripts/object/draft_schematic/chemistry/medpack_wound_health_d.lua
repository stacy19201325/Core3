...
object_draft_schematic_chemistry_medpack_wound_health_d = object_draft_schematic_chemistry_shared_medpack_wound_health_d:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Health Wound Medpack - D",
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_wound_health_d.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_wound_health_d, "object/draft_schematic/chemistry/medpack_wound_health_d.iff")
