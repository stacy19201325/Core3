...
object_draft_schematic_chemistry_medpack_poison_area_health_b = object_draft_schematic_chemistry_shared_medpack_poison_area_health_b:new {
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_poison_area_health_b.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_poison_area_health_b, "object/draft_schematic/chemistry/medpack_poison_area_health_b.iff")
