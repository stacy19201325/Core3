...
object_draft_schematic_chemistry_medpack_disease_area_stamina_b = object_draft_schematic_chemistry_shared_medpack_disease_area_stamina_b:new {
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_disease_area_stamina_b.iff",
