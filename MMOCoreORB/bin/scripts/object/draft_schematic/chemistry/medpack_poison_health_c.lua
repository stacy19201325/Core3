...
object_draft_schematic_chemistry_medpack_poison_health_c = object_draft_schematic_chemistry_shared_medpack_poison_health_c:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Health Poison Delivery Unit - C",
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_poison_health_c.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_poison_health_c, "object/draft_schematic/chemistry/medpack_poison_health_c.iff")
