...
object_draft_schematic_chemistry_med_stimpack_range_c = object_draft_schematic_chemistry_shared_med_stimpack_range_c:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Ranged Stimpack - C",
	...
	resourceQuantities = {8, 15, 15, 2, 1, 1},
...
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_med_stimpack_range_c, "object/draft_schematic/chemistry/med_stimpack_range_c.iff")
