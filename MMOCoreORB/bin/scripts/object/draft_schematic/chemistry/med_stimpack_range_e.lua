...
object_draft_schematic_chemistry_med_stimpack_range_e = object_draft_schematic_chemistry_shared_med_stimpack_range_e:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Ranged Stimpack - E",
	...
	resourceQuantities = {12, 18, 18, 3, 3, 3},
	contribution = {100, 100, 100, 100, 100, 100},

	targetTemplate = "object/tangible/medicine/crafted/medpack_grenade_damage_e.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_med_stimpack_range_e, "object/draft_schematic/chemistry/med_stimpack_range_e.iff")
