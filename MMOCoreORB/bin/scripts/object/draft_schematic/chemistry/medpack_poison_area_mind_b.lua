...
object_draft_schematic_chemistry_medpack_poison_area_mind_b = object_draft_schematic_chemistry_shared_medpack_poison_area_mind_b:new {
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_poison_area_mind_b.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_poison_area_mind_b, "object/draft_schematic/chemistry/medpack_poison_area_mind_b.iff")
