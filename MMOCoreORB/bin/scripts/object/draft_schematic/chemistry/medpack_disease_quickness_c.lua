...
object_draft_schematic_chemistry_medpack_disease_quickness_c = object_draft_schematic_chemistry_shared_medpack_disease_quickness_c:new {
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_disease_quickness_c.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_disease_quickness_c, "object/draft_schematic/chemistry/medpack_disease_quickness_c.iff")
