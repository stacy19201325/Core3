...
object_draft_schematic_chemistry_medpack_poison_area_health_c = object_draft_schematic_chemistry_shared_medpack_poison_area_health_c:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Health Area Poison Delivery Unit - C",
	...
	resourceQuantities = {12, 20, 25, 2, 2, 2},
	contribution = {100, 100, 100, 100, 100, 100},

	targetTemplate = "object/tangible/medicine/crafted/medpack_poison_area_health_c.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_poison_area_health_c, "object/draft_schematic/chemistry/medpack_poison_area_health_c.iff")
