...
object_draft_schematic_chemistry_medpack_enhance_health_c = object_draft_schematic_chemistry_shared_medpack_enhance_health_c:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Enhance Health Medpack - C",
	...
	resourceQuantities = {26, 26, 1, 2, 2},
	contribution = {100, 100, 100, 100, 100},

	targetTemplate = "object/tangible/medicine/crafted/medpack_enhance_health_c.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_enhance_health_c, "object/draft_schematic/chemistry/medpack_enhance_health_c.iff")
