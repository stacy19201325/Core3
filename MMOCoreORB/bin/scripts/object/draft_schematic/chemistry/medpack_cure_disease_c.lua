...
object_draft_schematic_chemistry_medpack_cure_disease_c = object_draft_schematic_chemistry_shared_medpack_cure_disease_c:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Cure Disease Medpack - C",
