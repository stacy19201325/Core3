...
object_draft_schematic_chemistry_medpack_wound_action_b = object_draft_schematic_chemistry_shared_medpack_wound_action_b:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Action Wound Medpack - B",
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_wound_action_b.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_wound_action_b, "object/draft_schematic/chemistry/medpack_wound_action_b.iff")
