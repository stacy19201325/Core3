...
object_draft_schematic_chemistry_medpack_disease_area_stamina_a = object_draft_schematic_chemistry_shared_medpack_disease_area_stamina_a:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Stamina Area Disease Delivery Unit - A",
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_disease_area_stamina_a.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_disease_area_stamina_a, "object/draft_schematic/chemistry/medpack_disease_area_stamina_a.iff")
