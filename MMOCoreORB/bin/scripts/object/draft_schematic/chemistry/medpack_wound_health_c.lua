...
object_draft_schematic_chemistry_medpack_wound_health_c = object_draft_schematic_chemistry_shared_medpack_wound_health_c:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Health Wound Medpack - C",
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_wound_health_c.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_wound_health_c, "object/draft_schematic/chemistry/medpack_wound_health_c.iff")
