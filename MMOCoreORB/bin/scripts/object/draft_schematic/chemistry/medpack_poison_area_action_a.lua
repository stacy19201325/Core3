...
object_draft_schematic_chemistry_medpack_poison_area_action_a = object_draft_schematic_chemistry_shared_medpack_poison_area_action_a:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Action Area Poison Delivery Unit - A",
	...
	resourceQuantities = {8, 10, 15, 1, 1, 1},
	contribution = {100, 100, 100, 100, 100, 100},

	targetTemplate = "object/tangible/medicine/crafted/medpack_poison_area_action_a.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_poison_area_action_a, "object/draft_schematic/chemistry/medpack_poison_area_action_a.iff")
