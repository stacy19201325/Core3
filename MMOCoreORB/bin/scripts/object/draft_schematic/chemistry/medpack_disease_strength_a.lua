...
object_draft_schematic_chemistry_medpack_disease_strength_a = object_draft_schematic_chemistry_shared_medpack_disease_strength_a:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Strength Disease Delivery Unit - A",
...
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_disease_strength_a, "object/draft_schematic/chemistry/medpack_disease_strength_a.iff")
