...
object_draft_schematic_chemistry_medpack_disease_area_health_a = object_draft_schematic_chemistry_shared_medpack_disease_area_health_a:new {
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_disease_area_health_a.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_disease_area_health_a, "object/draft_schematic/chemistry/medpack_disease_area_health_a.iff")
