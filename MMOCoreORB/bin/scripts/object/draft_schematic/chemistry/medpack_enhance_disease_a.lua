...
object_draft_schematic_chemistry_medpack_enhance_disease_a = object_draft_schematic_chemistry_shared_medpack_enhance_disease_a:new {
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_enhance_disease_a.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_enhance_disease_a, "object/draft_schematic/chemistry/medpack_enhance_disease_a.iff")
