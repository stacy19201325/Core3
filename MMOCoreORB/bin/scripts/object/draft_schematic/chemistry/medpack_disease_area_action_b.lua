...
object_draft_schematic_chemistry_medpack_disease_area_action_b = object_draft_schematic_chemistry_shared_medpack_disease_area_action_b:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Action Area Disease Delivery Unit - B",
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_disease_area_action_b.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_disease_area_action_b, "object/draft_schematic/chemistry/medpack_disease_area_action_b.iff")
