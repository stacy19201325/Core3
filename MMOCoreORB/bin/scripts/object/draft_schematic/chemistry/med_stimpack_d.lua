...
object_draft_schematic_chemistry_med_stimpack_d = object_draft_schematic_chemistry_shared_med_stimpack_d:new {
	...
	targetTemplate = "object/tangible/medicine/crafted/crafted_stimpack_sm_s1_d.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_med_stimpack_d, "object/draft_schematic/chemistry/med_stimpack_d.iff")
