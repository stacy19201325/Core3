...
object_draft_schematic_chemistry_medpack_poison_area_mind_c = object_draft_schematic_chemistry_shared_medpack_poison_area_mind_c:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Mind Area Poison Delivery Unit - C",
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_poison_area_mind_c.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_poison_area_mind_c, "object/draft_schematic/chemistry/medpack_poison_area_mind_c.iff")
