...
object_draft_schematic_chemistry_medpack_enhance_action_b = object_draft_schematic_chemistry_shared_medpack_enhance_action_b:new {
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_enhance_action_b.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_enhance_action_b, "object/draft_schematic/chemistry/medpack_enhance_action_b.iff")
