...
object_draft_schematic_chemistry_medpack_poison_action_a = object_draft_schematic_chemistry_shared_medpack_poison_action_a:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Action Poison Delivery Unit - A",
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_poison_action_a.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_poison_action_a, "object/draft_schematic/chemistry/medpack_poison_action_a.iff")
