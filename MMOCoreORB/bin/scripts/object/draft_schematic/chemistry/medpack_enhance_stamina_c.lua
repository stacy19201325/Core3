...
object_draft_schematic_chemistry_medpack_enhance_stamina_c = object_draft_schematic_chemistry_shared_medpack_enhance_stamina_c:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Enhance Stamina Medpack - C",
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_enhance_stamina_c.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_enhance_stamina_c, "object/draft_schematic/chemistry/medpack_enhance_stamina_c.iff")
