...
object_draft_schematic_chemistry_medpack_cure_disease_a = object_draft_schematic_chemistry_shared_medpack_cure_disease_a:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Cure Disease Medpack - A",
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_cure_disease_a.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_cure_disease_a, "object/draft_schematic/chemistry/medpack_cure_disease_a.iff")
