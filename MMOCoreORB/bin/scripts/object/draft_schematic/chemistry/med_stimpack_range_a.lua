...
object_draft_schematic_chemistry_med_stimpack_range_a = object_draft_schematic_chemistry_shared_med_stimpack_range_a:new {
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_grenade_damage_a.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_med_stimpack_range_a, "object/draft_schematic/chemistry/med_stimpack_range_a.iff")
