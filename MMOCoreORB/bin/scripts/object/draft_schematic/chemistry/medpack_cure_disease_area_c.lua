...
object_draft_schematic_chemistry_medpack_cure_disease_area_c = object_draft_schematic_chemistry_shared_medpack_cure_disease_area_c:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Cure Disease Medpack Area - C",
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_cure_disease_area_c.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_cure_disease_area_c, "object/draft_schematic/chemistry/medpack_cure_disease_area_c.iff")
