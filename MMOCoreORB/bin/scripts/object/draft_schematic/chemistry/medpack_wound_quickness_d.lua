...
object_draft_schematic_chemistry_medpack_wound_quickness_d = object_draft_schematic_chemistry_shared_medpack_wound_quickness_d:new {
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_wound_quickness_d.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_wound_quickness_d, "object/draft_schematic/chemistry/medpack_wound_quickness_d.iff")
