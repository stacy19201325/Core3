...
object_draft_schematic_chemistry_medpack_enhance_health_a = object_draft_schematic_chemistry_shared_medpack_enhance_health_a:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Enhance Health Medpack - A",
...
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_enhance_health_a, "object/draft_schematic/chemistry/medpack_enhance_health_a.iff")
