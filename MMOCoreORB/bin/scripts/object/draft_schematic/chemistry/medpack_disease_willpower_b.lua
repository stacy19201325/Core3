...
object_draft_schematic_chemistry_medpack_disease_willpower_b = object_draft_schematic_chemistry_shared_medpack_disease_willpower_b:new {
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_disease_willpower_b.iff",
