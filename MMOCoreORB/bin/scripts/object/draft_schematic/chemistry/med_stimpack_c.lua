...
object_draft_schematic_chemistry_med_stimpack_c = object_draft_schematic_chemistry_shared_med_stimpack_c:new {
	...
	targetTemplate = "object/tangible/medicine/crafted/crafted_stimpack_sm_s1_c.iff",
