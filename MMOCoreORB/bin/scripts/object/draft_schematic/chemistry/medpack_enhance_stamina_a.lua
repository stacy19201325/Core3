...
object_draft_schematic_chemistry_medpack_enhance_stamina_a = object_draft_schematic_chemistry_shared_medpack_enhance_stamina_a:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Enhance Stamina Medpack - A",
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_enhance_stamina_a.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_enhance_stamina_a, "object/draft_schematic/chemistry/medpack_enhance_stamina_a.iff")
