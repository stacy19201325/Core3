...
object_draft_schematic_chemistry_medpack_disease_area_action_c = object_draft_schematic_chemistry_shared_medpack_disease_area_action_c:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Action Area Disease Delivery Unit - C",
	...
	targetTemplate = "object/tangible/medicine/crafted/medpack_disease_area_action_c.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_disease_area_action_c, "object/draft_schematic/chemistry/medpack_disease_area_action_c.iff")
