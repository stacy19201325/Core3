...
object_draft_schematic_structure_naboo_house_player_medium = object_draft_schematic_structure_shared_naboo_house_player_medium:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_structure_naboo_house_player_medium, "object/draft_schematic/structure/naboo_house_player_medium.iff")
