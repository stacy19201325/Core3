...
object_draft_schematic_structure_house_player_large = object_draft_schematic_structure_shared_house_player_large:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Deed for: Large Tatooine House",
...
ObjectTemplates:addTemplate(object_draft_schematic_structure_house_player_large, "object/draft_schematic/structure/house_player_large.iff")
