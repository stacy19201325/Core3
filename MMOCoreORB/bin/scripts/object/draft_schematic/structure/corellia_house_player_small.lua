...
object_draft_schematic_structure_corellia_house_player_small = object_draft_schematic_structure_shared_corellia_house_player_small:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Deed for: Small Corellia House",
...
ObjectTemplates:addTemplate(object_draft_schematic_structure_corellia_house_player_small, "object/draft_schematic/structure/corellia_house_player_small.iff")
