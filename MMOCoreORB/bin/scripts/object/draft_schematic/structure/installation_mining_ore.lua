...
object_draft_schematic_structure_installation_mining_ore = object_draft_schematic_structure_shared_installation_mining_ore:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_structure_installation_mining_ore, "object/draft_schematic/structure/installation_mining_ore.iff")
