...
object_draft_schematic_structure_generic_house_player_small_style_02 = object_draft_schematic_structure_shared_generic_house_player_small_style_02:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Deed for: Small Generic Planet House (Style 2)",
...
ObjectTemplates:addTemplate(object_draft_schematic_structure_generic_house_player_small_style_02, "object/draft_schematic/structure/generic_house_player_small_style_02.iff")
