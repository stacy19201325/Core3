...
object_draft_schematic_structure_naboo_house_player_small_style_02 = object_draft_schematic_structure_shared_naboo_house_player_small_style_02:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Deed for: Small Naboo House (Style 2)",
   ...
   factoryCrateSize = 10000,	
	...
	targetTemplate = "object/tangible/deed/player_house_deed/naboo_house_small_style_02_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_structure_naboo_house_player_small_style_02, "object/draft_schematic/structure/naboo_house_player_small_style_02.iff")
