...
object_draft_schematic_structure_generic_house_player_large_style_02 = object_draft_schematic_structure_shared_generic_house_player_large_style_02:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Deed for: Large Generic Planet House (Style 2)",
	...
	targetTemplate = "object/tangible/deed/player_house_deed/generic_house_large_style_02_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_structure_generic_house_player_large_style_02, "object/draft_schematic/structure/generic_house_player_large_style_02.iff")
