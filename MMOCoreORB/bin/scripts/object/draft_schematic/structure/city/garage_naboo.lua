...
object_draft_schematic_structure_city_garage_naboo = object_draft_schematic_structure_city_shared_garage_naboo:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_structure_city_garage_naboo, "object/draft_schematic/structure/city/garage_naboo.iff")
