...
object_draft_schematic_structure_city_bank_naboo = object_draft_schematic_structure_city_shared_bank_naboo:new {
	...
	targetTemplate = "object/tangible/deed/city_deed/bank_naboo_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_structure_city_bank_naboo, "object/draft_schematic/structure/city/bank_naboo.iff")
