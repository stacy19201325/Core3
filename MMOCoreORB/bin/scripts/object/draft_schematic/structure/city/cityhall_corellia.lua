...
object_draft_schematic_structure_city_cityhall_corellia = object_draft_schematic_structure_city_shared_cityhall_corellia:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Deed for: Corellia City Hall",
