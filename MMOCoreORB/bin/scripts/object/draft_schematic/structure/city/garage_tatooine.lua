...
object_draft_schematic_structure_city_garage_tatooine = object_draft_schematic_structure_city_shared_garage_tatooine:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Deed for: Tatooine Garage",
...
ObjectTemplates:addTemplate(object_draft_schematic_structure_city_garage_tatooine, "object/draft_schematic/structure/city/garage_tatooine.iff")
