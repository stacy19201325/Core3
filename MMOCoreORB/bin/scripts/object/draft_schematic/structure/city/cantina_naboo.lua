...
object_draft_schematic_structure_city_cantina_naboo = object_draft_schematic_structure_city_shared_cantina_naboo:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Deed for: Naboo Cantina",
...
ObjectTemplates:addTemplate(object_draft_schematic_structure_city_cantina_naboo, "object/draft_schematic/structure/city/cantina_naboo.iff")
