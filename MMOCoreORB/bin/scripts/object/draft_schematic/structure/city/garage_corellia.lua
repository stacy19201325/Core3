...
object_draft_schematic_structure_city_garage_corellia = object_draft_schematic_structure_city_shared_garage_corellia:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Deed for: Corellia Garage",
	...
	targetTemplate = "object/tangible/deed/city_deed/garage_corellia_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_structure_city_garage_corellia, "object/draft_schematic/structure/city/garage_corellia.iff")
