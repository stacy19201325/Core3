...
object_draft_schematic_structure_city_hospital_naboo = object_draft_schematic_structure_city_shared_hospital_naboo:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Deed for: Naboo Hospital",
