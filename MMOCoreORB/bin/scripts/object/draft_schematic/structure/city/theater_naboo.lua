...
object_draft_schematic_structure_city_theater_naboo = object_draft_schematic_structure_city_shared_theater_naboo:new {
	...
	targetTemplate = "object/tangible/deed/city_deed/theater_naboo_deed.iff",
