...
object_draft_schematic_structure_city_cantina_tatooine = object_draft_schematic_structure_city_shared_cantina_tatooine:new {
	...
	targetTemplate = "object/tangible/deed/city_deed/cantina_tatooine_deed.iff",
