...
object_draft_schematic_structure_city_cloning_naboo = object_draft_schematic_structure_city_shared_cloning_naboo:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_structure_city_cloning_naboo, "object/draft_schematic/structure/city/cloning_naboo.iff")
