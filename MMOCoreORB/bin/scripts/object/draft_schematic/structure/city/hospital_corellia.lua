...
object_draft_schematic_structure_city_hospital_corellia = object_draft_schematic_structure_city_shared_hospital_corellia:new {
	...
	customObjectName = "Deed for: Corellia Hospital",
	...
	resourceQuantities = {1650, 2600, 450, 8, 2, 1},
	contribution = {100, 100, 100, 100, 100, 100},

	targetTemplate = "object/tangible/deed/city_deed/hospital_corellia_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_structure_city_hospital_corellia, "object/draft_schematic/structure/city/hospital_corellia.iff")
