...
object_draft_schematic_structure_city_cloning_tatooine = object_draft_schematic_structure_city_shared_cloning_tatooine:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_structure_city_cloning_tatooine, "object/draft_schematic/structure/city/cloning_tatooine.iff")
