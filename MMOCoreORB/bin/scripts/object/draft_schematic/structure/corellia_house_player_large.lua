...
object_draft_schematic_structure_corellia_house_player_large = object_draft_schematic_structure_shared_corellia_house_player_large:new {
	...
	targetTemplate = "object/tangible/deed/player_house_deed/corellia_house_large_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_structure_corellia_house_player_large, "object/draft_schematic/structure/corellia_house_player_large.iff")
