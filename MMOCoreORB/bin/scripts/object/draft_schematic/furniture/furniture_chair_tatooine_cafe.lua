...
object_draft_schematic_furniture_furniture_chair_tatooine_cafe = object_draft_schematic_furniture_shared_furniture_chair_tatooine_cafe:new {
   ...
   additionalTemplates = {
		"object/tangible/furniture/tatooine/shared_frn_tato_chair_cafe_style_02.iff",
		"object/tangible/camp/shared_camp_chair_s1.iff",
		"object/tangible/camp/shared_camp_chair_s2.iff",
