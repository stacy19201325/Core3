...
object_draft_schematic_droid_droid_r5_advanced = object_draft_schematic_droid_shared_droid_r5_advanced:new {
	...
	ingredientTitleNames = {"primary_frame", "leg_struts", "droid_brain", "manipulator_arm", "motivator", "sensor_suite", "general_droid_module", "general_droid_module2", "droid_defensive_module"},
	...
	targetTemplate = "object/tangible/deed/pet_deed/deed_r5_advanced_basic.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_droid_droid_r5_advanced, "object/draft_schematic/droid/droid_r5_advanced.iff")
