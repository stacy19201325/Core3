...
object_draft_schematic_droid_component_chassis_droid_probot = object_draft_schematic_droid_component_shared_chassis_droid_probot:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_droid_component_chassis_droid_probot, "object/draft_schematic/droid/component/chassis_droid_probot.iff")
