...
object_draft_schematic_droid_droid_treadwell_advanced = object_draft_schematic_droid_shared_droid_treadwell_advanced:new {
	...
	targetTemplate = "object/tangible/deed/pet_deed/deed_treadwell_advanced_basic.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_droid_droid_treadwell_advanced, "object/draft_schematic/droid/droid_treadwell_advanced.iff")
