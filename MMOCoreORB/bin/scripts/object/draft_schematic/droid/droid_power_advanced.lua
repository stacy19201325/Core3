...
object_draft_schematic_droid_droid_power_advanced = object_draft_schematic_droid_shared_droid_power_advanced:new {
	...
	targetTemplate = "object/tangible/deed/pet_deed/deed_power_advanced_basic.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_droid_droid_power_advanced, "object/draft_schematic/droid/droid_power_advanced.iff")
