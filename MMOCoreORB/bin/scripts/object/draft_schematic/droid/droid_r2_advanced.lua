...
object_draft_schematic_droid_droid_r2_advanced = object_draft_schematic_droid_shared_droid_r2_advanced:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Deed for: R2 Droid, Advanced Model",
...
ObjectTemplates:addTemplate(object_draft_schematic_droid_droid_r2_advanced, "object/draft_schematic/droid/droid_r2_advanced.iff")
