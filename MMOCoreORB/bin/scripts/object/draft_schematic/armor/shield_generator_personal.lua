...
object_draft_schematic_armor_shield_generator_personal = object_draft_schematic_armor_shared_shield_generator_personal:new {
	...
	resourceQuantities = {35, 10, 10, 1, 1, 1, 1, 1, 1},
	contribution = {100, 100, 100, 100, 100, 100, 100, 100, 100},

	targetTemplate = "object/tangible/component/armor/shield_generator_personal.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_armor_shield_generator_personal, "object/draft_schematic/armor/shield_generator_personal.iff")
