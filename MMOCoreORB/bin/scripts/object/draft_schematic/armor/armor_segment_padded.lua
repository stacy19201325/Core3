...
object_draft_schematic_armor_armor_segment_padded = object_draft_schematic_armor_shared_armor_segment_padded:new {
	...
	targetTemplate = "object/tangible/component/armor/armor_segment_padded.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_segment_padded, "object/draft_schematic/armor/armor_segment_padded.iff")
