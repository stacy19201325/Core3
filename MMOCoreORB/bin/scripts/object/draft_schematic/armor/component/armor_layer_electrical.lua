...
ObjectTemplates:addTemplate(object_draft_schematic_armor_component_armor_layer_electrical, "object/draft_schematic/armor/component/armor_layer_electrical.iff")
