...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_segment_composite_advanced, "object/draft_schematic/armor/armor_segment_composite_advanced.iff")
