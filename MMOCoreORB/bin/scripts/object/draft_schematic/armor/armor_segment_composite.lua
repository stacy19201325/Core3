...
object_draft_schematic_armor_armor_segment_composite = object_draft_schematic_armor_shared_armor_segment_composite:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_segment_composite, "object/draft_schematic/armor/armor_segment_composite.iff")
