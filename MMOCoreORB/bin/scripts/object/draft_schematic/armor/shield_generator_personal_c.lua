...
object_draft_schematic_armor_shield_generator_personal_c = object_draft_schematic_armor_shared_shield_generator_personal_c:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Personal Shield Generator Mk.3",
