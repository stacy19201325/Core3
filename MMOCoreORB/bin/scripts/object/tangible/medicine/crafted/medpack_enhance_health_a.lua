...
object_tangible_medicine_crafted_medpack_enhance_health_a = object_tangible_medicine_crafted_shared_medpack_enhance_health_a:new {
	gameObjectType = 8238,
	...
	experimentalMin = {0, 0, 10, 5, 14200, 60, 1000},
	experimentalMax = {0, 0, 100, 10, 21600, 50, 1000},
	experimentalPrecision = {0, 0, 0, 0, 0, 0, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 4},
}

ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_enhance_health_a, "object/tangible/medicine/crafted/medpack_enhance_health_a.iff")
