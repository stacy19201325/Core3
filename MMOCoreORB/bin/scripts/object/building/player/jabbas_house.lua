...
shopSigns = {
		...
		{templateFile = "object/tangible/sign/player/shop_sign_s04.iff", x = 1.4, z = 0.5, y = -4.91, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:shop_sign4"}
	}
