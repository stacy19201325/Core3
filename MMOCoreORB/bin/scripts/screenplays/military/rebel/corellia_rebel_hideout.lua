...
function RebelHideoutScreenPlay:spawnMobiles()
	...
	spawnMobile("corellia", "sentry_specforce", 300, -6417.8, 405.0, 6023.4, 150, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6423.3, 405.0, 6032.5, -22, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6426.9, 405.0, 6031.4, -25, 0)
	spawnMobile("corellia", "sentry_specforce_sniper", 300, -6427.5, 405.0, 6024.2, 17, 0)
...
--	spawnMobile("corellia", "sentry_specforce_rebel_major", 300, -6446.6, 403.2, 6021.5, 68, 0)
	...
	spawnMobile("corellia", "sentry_specforce", 300, -6454.1, 398.0, 6011.7, -114, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6456.8, 398.0, 6017.6, -114, 0)
	
	-- South East Stairs
	spawnMobile("corellia", "sentry_specforce", 300, -6492.260, 398.000, 5939.580, 11.765, 0)
	spawnMobile("corellia", "sentry_rebel_major", 300, -6498.480, 398.000, 5938.420, 10.799, 0)
...
--	spawnMobile("corellia", "sentry_specforce_sniper", 300, -6494.0 403.0, 5926.7, 171, 0)
	...
	spawnMobile("corellia", "sentry_specforce", 300, -6525.8, 398.0, 5975.5, -137, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6520.8, 398.0, 5970.6, -128, 0)
	...
	spawnMobile("corellia", "sentry_specforce", 300, -6464.5, 398.0, 5960.8, -136, 0)
	...
	spawnMobile("corellia", "sentry_specforce", 300, -6533.2, 398.0, 6039.5, 164, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6520.1, 398.0, 6044.0, 167, 0)
	...
	spawnMobile("corellia", "sentry_specforce", 300, -6496.5, 398.0, 6022.4, -59, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6490.0, 405.0, 6010.0, 132, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6486.4, 404.9, 6006.0, -41, 0)
	spawnMobile("corellia", "sentry_specforce_squad_leader", 300, 6483.6, 404.9, 6009.7, -46, 0)

	-- Mission Terminal by Stairs

	spawnMobile("corellia", "sentry_specforce", 300, -6485.1, 398.0, 6014.8, 46, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6485.4, 398.0, 6006.5, 126, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6489.9, 398.0, 6010.8, -45, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6485.7, 398.0, 6011.0, -131, 0)
	...
	spawnMobile("corellia", "sentry_specforce", 300, -6529.1, 405.0, 5979.6, 132, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6531.9, 405.0, 5982.4, -44, 0)
	...
	spawnMobile("corellia", "sentry_specforce", 300, -6476.6, 398.0, 6033.0, -154, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6480.4, 398.0, 6035.1, -157, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6497.6, 398.0, 6041.3, -165, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6501.8, 398.0, 6042.2, -167, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6542.0, 398.0, 6028.3, 132, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6544.8, 398.0, 6025.2, 132, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6552.0, 398.0, 6007.0, 99, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6552.6, 398.0, 6002.6, 100, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6484.5, 398.0, 5961.8, 44, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6487.4, 398.0, 5964.7, 44, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6477.5, 398.0, 5974.7, -134, 0)
	spawnMobile("corellia", "sentry_specforce", 300, -6474.7, 398.0, 5971.8, -135, 0)
