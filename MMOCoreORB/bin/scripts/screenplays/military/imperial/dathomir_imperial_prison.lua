...
--	spawnMobile("dathomir", "force_sensitive_renegade", 600, -6277.7, 119.9, 937.2, -100, 0)
	...
	spawnMobile("dathomir", "pirate", 300, -6276.5, 119.9, 897.4, -140, 0)
	spawnMobile("dathomir", "crimelord", 300, -6306.5, 119.9, 905.4, 140, 0)
	spawnMobile("dathomir", "common_thief", 300, -6297.6, 119.9, 874.6, -100, 0)
	spawnMobile("dathomir", "thug", 300, -6302.5, 119.9, 872.4, 60, 0)
	spawnMobile("dathomir", "thug", 300, -6299.5, 119.9, 877.7, 160, 0)
	spawnMobile("dathomir", "crimelord", 300, -6319.5, 119.9, 873.4, -140, 0)
	spawnMobile("dathomir", "thug", 300, -6339.5, 119.9, 877.4, 40, 0)
	spawnMobile("dathomir", "common_thief", 300, -6357.5, 119.9, 853.4, -21, 0)
	spawnMobile("dathomir", "thug", 300, -6419.8, 129.5, 883.9, -62, 0)

	spawnMobile("dathomir", "common_thief", 300, -6190.2, 119.9, 992.6, -126, 0)
	spawnMobile("dathomir", "pirate_privateer", 300, -6201.2, 119.9, 993.6, 176, 0)
	spawnMobile("dathomir", "thug", 300, -6186.2, 119.9, 954.2, 166, 0)
	spawnMobile("dathomir", "crimelord", 300, -6258.5, 119.9, 1006.6, -126, 0)
	spawnMobile("dathomir", "thug", 300, -6325.2, 119.9, 958.6, -16, 0)
	spawnMobile("dathomir", "common_thief", 300, -6463.7, 119.9, 992.6, 136, 0)
	spawnMobile("dathomir", "thug", 300, -6429.2, 119.9, 1001.6, 86, 0)
	spawnMobile("dathomir", "pirate_privateer", 300, -6414.3, 119.9, 1042.4, -156, 0)
	spawnMobile("dathomir", "crimelord", 300, -6415.7, 119.9, 1039.3, 24, 0)
	spawnMobile("dathomir", "thug", 300, -6427.9, 119.9, 920.6, 100, 0)
	...
	spawnMobile("dathomir", "thug", 300, -4.5, 0.1, -1.2, 166, 5335770)

	spawnMobile("dathomir", "commoner_old", 300, -4.5, 0.1, -1.2, 166, 5335777)
	spawnMobile("dathomir", "crimelord", 300, -4.9, 0.1, -2.4, 16, 5335777)
	spawnMobile("dathomir", "common_thief", 300, -4.2, 0.1, -3.6, -66, 5335777)
	spawnMobile("dathomir", "common_thief", 300, -4.5, 0.1, -4.8, 96, 5335777)
	...
	spawnMobile("dathomir", "crimelord", 300, 4.5, 0.1, -3.6, 180, 5335804)
	spawnMobile("dathomir", "commoner_old", 30, 3.0, 0.1, -5.6, -60, 5335804)

	spawnMobile("dathomir", "thug", 300, -4.5, 0.1, -1.2, 166, 5335819)
	spawnMobile("dathomir", "thug", 300, -4.9, 0.1, -2.4, 16, 5335819)
	spawnMobile("dathomir", "thug", 300, -4.2, 0.1, -3.6, -66, 5335819)
	spawnMobile("dathomir", "thug", 300, -4.5, 0.1, -4.8, 96, 5335819)
	spawnMobile("dathomir", "pirate", 300, 4.5, 0.1, -2.2, 0, 5335818)
	spawnMobile("dathomir", "pirate", 300, 4.5, 0.1, -3.6, 90, 5335818)
	spawnMobile("dathomir", "pirate", 300, 3.0, 0.1, -5.6, -60, 5335818)
	spawnMobile("dathomir", "pirate_privateer", 300, 3.8, 0.1, 1.5, 0, 5335817)
	...
	spawnMobile("dathomir", "imperial_inquisitor", 600, 9.9, 1.0, -21.6, 33, 2665369)
	...
	spawnMobile("dathomir", "gaping_spider", 300, -4.4, -9.8, -11.3, -43, 2635354)
	spawnMobile("dathomir", "gaping_spider_hunter", 300, 5.0, -11.5, -17.6, -60, 2635354)
	spawnMobile("dathomir", "gaping_spider", 300, -1.7, -10.6, -18.0, -35, 2635354)
	spawnMobile("dathomir", "gaping_spider_hunter", 300, 14.3, -18.8, -33.6, 4, 2635354)
	spawnMobile("dathomir", "gaping_spider_hunter", 300, 8.9, -21.9, -37.6, 103, 2635354)

	spawnMobile("dathomir", "gaping_spider_hunter", 300, -34.5, -45.6, -80.2, 50, 2635355)
	spawnMobile("dathomir", "gaping_spider_hunter", 300, -40.6, -48.2, -84.2, 57, 2635355)

	spawnMobile("dathomir", "gaping_spider_queen", 300, -5.3, -48.5, -170.6, -33, 2635357)
	spawnMobile("dathomir", "gaping_spider_broodling", 300, -6.8, -48.5, -182.7, -33, 2635357)
	spawnMobile("dathomir", "gaping_spider_broodling", 300, -4.3, -48.3, -181.5, -43, 2635357)
	spawnMobile("dathomir", "gaping_spider_broodling", 300, -1.3, -48.4, -180.6, 133, 2635357)
	spawnMobile("dathomir", "gaping_spider_broodling", 300, -1.3, -48.9, -177.2, 73, 2635357)
	spawnMobile("dathomir", "gaping_spider_broodling", 300, -4.6, -48.6, -174.8, -13, 2635357)
	spawnMobile("dathomir", "gaping_spider_broodling", 300, 9.6, -50.6, -158.3, -167, 2635357)
	spawnMobile("dathomir", "gaping_spider_broodling", 300, 12.0, -51.0, -163.3, -133, 2635357)

	spawnMobile("dathomir", "giant_gaping_spider_recluse", 300, -74.3, -70.2, -194.3, 90, 2635361)

	spawnMobile("dathomir", "gaping_spider_queen", 300, 38.4, -81.6, -238.5, -45, 2635363)
	spawnMobile("dathomir", "gaping_spider_hunter", 300, 39.5, -79.1, -226.6, -33, 2635363)
	spawnMobile("dathomir", "gaping_spider_hunter", 300, 26.3, -79.0, -233.0, 0, 2635363)
	spawnMobile("dathomir", "gaping_spider_broodling", 300, 62.3, -80.9, -229.7, -83, 2635363)
	spawnMobile("dathomir", "gaping_spider_broodling", 300, 63.5, -81.9, -234.1, -83, 2635363)
	spawnMobile("dathomir", "gaping_spider_broodling", 300, 59.8, -81.9, -238.3, -23, 2635363)
	spawnMobile("dathomir", "gaping_spider_broodling", 300, 51.9, -79.5, -249.4, -43, 2635363)
	spawnMobile("dathomir", "gaping_spider_broodling", 300, 42.5, -79.3, -250.8, -23, 2635363)

	spawnMobile("dathomir", "gaping_spider_recluse", 300, 29.6, -79.9, -267.1, -60, 2635365)
	spawnMobile("dathomir", "gaping_spider_recluse_queen", 300, 21.6, -79.9, -265.0, -20, 2635365)
	spawnMobile("dathomir", "gaping_spider_recluse", 300, 11.6, -79.9, -266.7, 60, 2635365)
	spawnMobile("dathomir", "giant_gaping_spider_recluse", 300, 28.2, -80.6, -282.6, -25, 2635365)
