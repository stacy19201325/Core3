...
function ImperialZephyrScreenPlay:teleportImpRetreat(pCollectorA, pPlayer)
	...
	if CreatureObject(pPlayer):isImperial() then	
		SceneObject(pPlayer):switchZone("naboo", 2437.8, 0, -3895.7, 0)
	else
...
function ImperialZephyrScreenPlay:teleportTatHQ(pCollector13, pPlayer)
	...
	if CreatureObject(pPlayer):isImperial() then	
		SceneObject(pPlayer):switchZone("tatooine", -2583, 0, 2072, 0)
	else
		CreatureObject(pPlayer):sendSystemMessage("You are not authorized to use this terminal")
	end
	return 0
...
function ImperialZephyrScreenPlay:teleportTalus(pCollectorD, pPlayer)
	...
	if CreatureObject(pPlayer):isImperial() then	
		SceneObject(pPlayer):switchZone("talus", -2212, 0, 2325, 0)
	else
		CreatureObject(pPlayer):sendSystemMessage("You are not authorized to use this terminal")
	end
	return 0
...
function ImperialZephyrScreenPlay:teleportDantooine(pCollectorE, pPlayer)
	...
	if CreatureObject(pPlayer):isImperial() then	
		SceneObject(pPlayer):switchZone("dantooine", -4222.4, 3.0, -2360.9, -90)
	else
		CreatureObject(pPlayer):sendSystemMessage("You are not authorized to use this terminal")
	end
	return 0
...
function ImperialZephyrScreenPlay:teleportYavin4(pCollectorF, pPlayer)
	...
	if CreatureObject(pPlayer):isImperial() then	
		SceneObject(pPlayer):switchZone("yavin4", 4042.2, 3.0, -6228.3, -90)
	else
		CreatureObject(pPlayer):sendSystemMessage("You are not authorized to use this terminal")
	end
	return 0
...
function ImperialZephyrScreenPlay:teleportImpStronghold(pCollectorG, pPlayer)
	...
	if CreatureObject(pPlayer):isImperial() then	
		SceneObject(pPlayer):switchZone("corellia", 4621.7, 0, -5792.2, 0)
	else
		CreatureObject(pPlayer):sendSystemMessage("You are not authorized to use this terminal")
	end
	return 0
...
function ImperialZephyrScreenPlay:teleportImpOasis(pCollectorH, pPlayer)
	...
	if CreatureObject(pPlayer):isImperial() then	
		SceneObject(pPlayer):switchZone("tatooine", -5369, 0, 2748, 0)
	else
		CreatureObject(pPlayer):sendSystemMessage("You are not authorized to use this terminal")
	end
	return 0
...
function ImperialZephyrScreenPlay:teleportImpOutpostKaadara(pCollectorI, pPlayer)
	...
	if CreatureObject(pPlayer):isImperial() then	
		SceneObject(pPlayer):switchZone("naboo", 5333, 0, 6433, 0)
	else
		CreatureObject(pPlayer):sendSystemMessage("You are not authorized to use this terminal")
	end
	return 0
...
function ImperialZephyrScreenPlay:teleportImpEncampmentRori(pCollectorJ, pPlayer)
	...
	if CreatureObject(pPlayer):isImperial() then	
		SceneObject(pPlayer):switchZone("rori", -5573.4, 0, -5620.9, 0)
	else
		CreatureObject(pPlayer):sendSystemMessage("You are not authorized to use this terminal")
	end
	return 0
...
function ImperialZephyrScreenPlay:teleportPrisonLok(pCollectorK, pPlayer)
	...
	if CreatureObject(pPlayer):isImperial() then	
		SceneObject(pPlayer):switchZone("lok", -1938, 0, -3133, 0)
	else
		CreatureObject(pPlayer):sendSystemMessage("You are not authorized to use this terminal")
	end
	return 0
...
function ImperialZephyrScreenPlay:teleportPrisonDath(pCollectorK, pPlayer)
	...
	if CreatureObject(pPlayer):isImperial() then	
		SceneObject(pPlayer):switchZone("dathomir", -6231, 0, 946, 0)
	else
		CreatureObject(pPlayer):sendSystemMessage("You are not authorized to use this terminal")
	end
	return 0
