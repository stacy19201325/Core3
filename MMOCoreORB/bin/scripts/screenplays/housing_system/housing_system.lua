...
includeFile("housing_system/housing_system_layouts.lua")
includeFile("housing_system/locations_corellia.lua")
includeFile("housing_system/locations_dantooine.lua")
includeFile("housing_system/locations_dathomir.lua")
includeFile("housing_system/locations_endor.lua")
includeFile("housing_system/locations_lok.lua")
includeFile("housing_system/locations_naboo.lua")
includeFile("housing_system/locations_rori.lua")
includeFile("housing_system/locations_talus.lua")
includeFile("housing_system/locations_tatooine.lua")
includeFile("housing_system/locations_yavin4.lua")
...
HondoHousingSystem = ScreenPlay:new {
	...
	maxOwnedPlots = 3, -- Max account-wide plots a player can own. 0 = unlimited.
	...
	for i = 1, #locTable, 1 do
		...
		for j = 1, #layouts[locTable[i].layout].plots, 1 do
			...
			if (plotUsed ~= 1) then
				...
				local rotation = HondoHousingSystem:roundNumber(locTable[i].center.angle + layouts[locTable[i].layout].plots[j].localRotation)
