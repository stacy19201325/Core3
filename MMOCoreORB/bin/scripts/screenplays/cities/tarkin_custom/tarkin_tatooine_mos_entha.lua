TarkinTatooineMosEnthaScreenPlay = CityScreenPlay:new {
	numberOfActs = 1,

	screenplayName = "TarkinTatooineMosEnthaScreenPlay",

	planet = "tatooine",

--	gcwMobs = {
--		{"comm_operator", "rebel_resistance_leader", 1626.03,7.36699,3513.56,31.2213,0, "npc_imperial", "conversation"},
...
registerScreenPlay("TarkinTatooineMosEnthaScreenPlay", true)

function TarkinTatooineMosEnthaScreenPlay:start()
...
function TarkinTatooineMosEnthaScreenPlay:spawnSceneObjects()
...
function TarkinTatooineMosEnthaScreenPlay:spawnMobiles()

	--Anything dashed out will need to be added here and removed from spawn manager once the spawnMobiles command is extended.

	--eastern Tavern
	local pNpc = spawnMobile(self.planet, "scientist",60,1674,7,2964,265,0)
	self:setMoodString(pNpc, "neutral")
	spawnMobile(self.planet, "scientist",60,1675,7,2969,285,0)
...
--	self:setMoodString(pNpc, "sad")
	...
	--Hotel
	pNpc = spawnMobile(self.planet, "businessman",60,1467,7,3136,270,0)
--	self:setMoodString(pNpc, "sad")
...
--	self:setMoodString(pNpc, "npc_use_terminal_high")
	spawnMobile(self.planet, "businessman",60,1460,7,3174,180,0)
...
--	self:setMoodString(pNpc, "worried")
	pNpc = spawnMobile(self.planet, "businessman",60,1468,7,3160,270,0)
--	self:setMoodString(pNpc, "npc_accusing")
--	pNpc = spawnMobile(self.planet, "judge",60,-5.7,1.0,4.2,112,1153988)
--	self:setMoodString(pNpc, "npc_standing_drinking")
	--center Tavern AA
	pNpc = spawnMobile(self.planet, "scientist",60,1475,7,3182,0,0)
--	self:setMoodString(pNpc, "sad")
...
--	spawnMobile(self.planet, "brawler",300,-14.01,1.13306,-8.53,120.004,1153566)
	spawnMobile(self.planet, "businessman",60,1458,7,3108,0,0)
...
--	spawnMobile(self.planet, "surgical_droid_21b",60,-25.52,0.26,-3.48,142.122,1153586)
	spawnMobile(self.planet, "trainer_combatmedic",0,1378,7,3239,0,0)
...
--	self:setMoodString(pNpc, "conversation")
	spawnMobile(self.planet, "theater_manager",60,1687,7,3074,0,0)
...
--	self:setMoodString(pNpc, "conversation")
	spawnMobile(self.planet, "businessman",60,1299,7,3122,42.5733,0)
	spawnMobile(self.planet, "businessman",60,1565,7,3412,0,0)
...
--	self:setMoodString(pNpc, "calm")
	spawnMobile(self.planet, "criminal",300,1257,7,3148,0,0)
	spawnMobile(self.planet, "criminal",300,1712,7,3213,202.393,0)
	spawnMobile(self.planet, "criminal",300,1713,7,3219,270,0)
...
--	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "noble",60,1205,7,2955,360.011,0)
--	self:setMoodString(pNpc, "conversation")
...
--	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "scientist",60,1333,7,3089,180,0)
--	self:setMoodString(pNpc, "conversation")
...
--	spawnMobile(self.planet, "trainer_brawler",0,1741,7,3117,0,0)
	spawnMobile(self.planet, "trainer_carbine",0,1196,7,3110,180,0)
	spawnMobile(self.planet, "trainer_commando",0,1564,7,3413,0,0)
	spawnMobile(self.planet, "trainer_creaturehandler",0,1381,7,3241,0,0)
	spawnMobile(self.planet, "trainer_doctor",0,1380,7,3240,0,0)
	--spawnMobile(self.planet, "trainer_entertainer",0,1287,7,3163,85,0)
	spawnMobile(self.planet, "trainer_marksman",0,1305,7,3090,90,0)
	spawnMobile(self.planet, "trainer_medic",0,1301,7,3118,90,0)
	spawnMobile(self.planet, "trainer_merchant",0,1272,7,3141,0,0)
	--spawnMobile(self.planet, "trainer_musician",0,1481,7,3267,0,0)
	spawnMobile(self.planet, "trainer_ranger",0,1378,7,3474,180,0)
	spawnMobile(self.planet, "trainer_scout",0,1268,7,3141,0,0)
