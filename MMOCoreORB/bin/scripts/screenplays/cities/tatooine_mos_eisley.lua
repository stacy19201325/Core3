...
function TatooineMosEisleyScreenPlay:spawnMobiles()
	...
	pNpc = spawnMobile(self.planet, "commoner_tatooine",60,29.6,0.1,-7.4,71,1082876)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "commoner_tatooine",60,30.9,0.1,-8.8,10,1082876)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "commoner_tatooine",60,29.4,0.1,-6.1,107,1082876)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "commoner_tatooine",60,35.7,0.1,3.1,180,1082876)
	self:setMoodString(pNpc, "npc_sitting_table")
	pNpc = spawnMobile(self.planet, "bartender",60,-11.5,-0.9,2,230,1082877)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "businessman",60,10.65,-0.894992,1.91,330,1082877)
	self:setMoodString(pNpc, "npc_standing_drinking")
	pNpc = spawnMobile(self.planet, "businessman",60,-4.11,-0.894992,5.4,26.8951,1082877)
	self:setMoodString(pNpc, "happy")
	pNpc = spawnMobile(self.planet, "chadra_fan_female",60,10.43,-0.894992,-1.47,123.102,1082877)
	self:setMoodString(pNpc, "worried")
	spawnMobile(self.planet, "chadra_fan_male",60,10.7,-0.894992,-0.23,80.4821,1082877)
	pNpc = spawnMobile(self.planet, "commoner",60,10.17,-0.894992,2.74,125.098,1082877)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "commoner_fat",60,2.11,-0.894992,5.4,180,1082877)
	self:setMoodString(pNpc, "npc_standing_drinking")
	pNpc = spawnMobile(self.planet, "commoner_fat",60,-2.2,-0.9,-10.9,65,1082877)
	self:setMoodString(pNpc, "npc_sitting_table_eating")
	pNpc = spawnMobile(self.planet, "commoner_naboo",60,3.11,0,5.4,161.005,1082877)
	self:setMoodString(pNpc, "bored")
	pNpc = spawnMobile(self.planet, "commoner_naboo",60,1.11,0,5.4,330.024,1082877)
	self:setMoodString(pNpc, "npc_standing_drinking")
	pNpc = spawnMobile(self.planet, "commoner_naboo",60,-3.11,0,5.4,16.6733,1082877)
	self:setMoodString(pNpc, "npc_standing_drinking")
	pNpc = spawnMobile(self.planet, "commoner_naboo",60,16.1,-0.9,4.1,340,1082877)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "commoner_tatooine",60,4.11,-0.894992,5.4,158.443,1082877)
	self:setMoodString(pNpc, "npc_standing_drinking")
	pNpc = spawnMobile(self.planet, "commoner_tatooine",60,1.99,-0.894992,-8.44,325.01,1082877)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "commoner_tatooine",60,1.19,-0.894992,-7.63,152.004,1082877)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "entertainer",60,9.4,0,3.9,310,1082877)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "marco_vahn",60,-9.34,-0.894992,5.66,59.306,1082877)
	self:setMoodString(pNpc, "calm")
	pNpc = spawnMobile(self.planet, "muftak",60,20.2,-0.9,5,107,1082877)
	self:setMoodString(pNpc, "happy")
	pNpc = spawnMobile(self.planet, "noble",60,8.49,-0.894992,4.64,128.74,1082877)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "patron",60,14.2,-0.9,-4.8,67,1082877)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "patron",60,14.7,-0.9,-3,147,1082877)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "patron",60,16.5,-0.9,-4.8,320,1082877)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "patron",60,24.5,-0.9,-8.1,51,1082877)
	self:setMoodString(pNpc, "npc_sitting_table")
	pNpc = spawnMobile(self.planet, "patron",60,26.1,-0.9,-8.2,317,1082877)
	self:setMoodString(pNpc, "npc_sitting_table_eating")
	pNpc = spawnMobile(self.planet, "patron",60,8.8,-0.9,-6,208,1082877)
	self:setMoodString(pNpc, "entertained")
	pNpc = spawnMobile(self.planet, "patron",60,6.8,-0.9,-6.5,230,1082877)
	self:setMoodString(pNpc, "entertained")
	pNpc = spawnMobile(self.planet, "patron",60,-2.2,-0.9,11.8,97,1082877)
	self:setMoodString(pNpc, "npc_sitting_table")
	pNpc = spawnMobile(self.planet, "patron",60,0.6,-0.9,11.9,269,1082877)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "patron_chiss",60,3.62,-0.894992,-4.77,184.005,1082877)
	self:setMoodString(pNpc, "sad")
	pNpc = spawnMobile(self.planet, "patron_chiss",60,1.74,-0.894992,-4.91,95.0028,1082877)
	self:setMoodString(pNpc, "npc_consoling")
	pNpc = spawnMobile(self.planet, "patron_devaronian",60,21.4,-0.9,5.4,161,1082877)
	self:setMoodString(pNpc, "npc_sitting_table")
	pNpc = spawnMobile(self.planet, "patron_ishitib",60,22.3,-0.9,3.1,339,1082877)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "patron_ithorian",60,14.9,-0.9,4.9,51,1082877)
	self:setMoodString(pNpc, "npc_sitting_table")
	pNpc = spawnMobile(self.planet, "patron_klaatu",60,15,-0.9,6.9,139,1082877)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "patron_nikto",60,23.4,-0.9,4.8,272,1082877)
	self:setMoodString(pNpc, "npc_sitting_chair")
	...
	self:setMoodString(pNpc, "worried")
	pNpc = spawnMobile(self.planet, "doikk_nats",60,2.32,-0.894992,-16.47,44.0013,1082880)
	self:setMoodString(pNpc, "themepark_music_3")
	pNpc = spawnMobile(self.planet, "figrin_dan",60,3.69,-0.894992,-14.4,50.0015,1082880)
	self:setMoodString(pNpc, "themepark_music_3")
	pNpc = spawnMobile(self.planet, "nalan_cheel",60,0.54,-0.894992,-17.13,38.0011,1082880)
	self:setMoodString(pNpc, "themepark_music_1")
	pNpc = spawnMobile(self.planet, "tech_mor",60,4.11,-0.894992,-17.07,45.0013,1082880)
	self:setMoodString(pNpc, "themepark_music_2")
	pNpc = spawnMobile(self.planet, "tedn_dahai",60,1.29,-0.894992,-15.18,70.0021,1082880)
	self:setMoodString(pNpc, "themepark_music_3")
	...
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "eg6_power_droid",60,-0.7,0.4,-0.8,-90,1188034)
	self:setMoodString(pNpc, "worried")
	pNpc = spawnMobile(self.planet, "surgical_droid_21b",60,-2.3,0.4,-0.9,90,1188034)
	self:setMoodString(pNpc, "angry")
	pNpc = spawnMobile(self.planet, "surgical_droid_21b",60,0,0.4,-2.6,0,1188034)
	self:setMoodString(pNpc, "angry")
	pNpc = spawnMobile(self.planet, "surgical_droid_21b",60,1.0,0.4,-0.7,-102,1188034)
	self:setMoodString(pNpc, "angry")
	pNpc = spawnMobile(self.planet, "surgical_droid_21b",60,-1.0,0.4,0.4,173,1188034)
	self:setMoodString(pNpc, "angry")
	pNpc = spawnMobile(self.planet, "info_broker",60,-9.1,1.0,8.0,141,1188035)
	self:setMoodString(pNpc, "npc_sitting_table_eating")
	pNpc = spawnMobile(self.planet, "contractor",60,-9.3,1.0,5.0,58,1188035)
	self:setMoodString(pNpc, "npc_sitting_table_eating")

	--western Tavern B
	pNpc = spawnMobile(self.planet, "sullustan_male",60,0.7,1.0,6.9,-42,1188048)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "sullustan_male",60,-1.8,1.0,8.8,-130,1188048)
	self:setMoodString(pNpc, "npc_sitting_table")
	pNpc = spawnMobile(self.planet, "sullustan_male",60,-5.6,1.0,8.8,136,1188048)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "businessman",60,-8.1,1.0,7.0,97,1188048)
	self:setMoodString(pNpc, "npc_sitting_table_eating")
	pNpc = spawnMobile(self.planet, "sullustan_male",60,-5.7,1.0,5.1,43,1188048)
	self:setMoodString(pNpc, "npc_sitting_table")
	pNpc = spawnMobile(self.planet, "sullustan_male",60,-1.9,1.0,5.1,-26,1188048)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "entertainer",60,-6.9,0.4,-6.3,-90,1188047)
	self:setMoodString(pNpc, "calm")

	--western Tavern C
	pNpc = spawnMobile(self.planet, "chiss_female",60,0.4,1.0,6.8,-42,1187987)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "scientist",60,0,1.0,6.5,62,1187987)
	self:setMoodString(pNpc, "sad")
	pNpc = spawnMobile(self.planet, "jawa",360,-5.4,0.4,-7.4,0,1187986)
	self:setMoodString(pNpc, "nervous")

	--western Tavern D
	pNpc = spawnMobile(self.planet, "r4",60,4.7,1.0,4.5,50,1187918)
	self:setMoodString(pNpc, "happy")
	pNpc = spawnMobile(self.planet, "shadowy_figure",60,3.0,0.4,-0.4,175,1187919)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "twilek_slave",60,2.9,0.4,-4.1,0,1187919)
	self:setMoodString(pNpc, "npc_sitting_ground")
	pNpc = spawnMobile(self.planet, "patron_devaronian",60,1.7,0.4,-2.0,152,1187919)
	self:setMoodString(pNpc, "npc_consoling")
	pNpc = spawnMobile(self.planet, "patron_devaronian",60,0.5,0.4,-3.2,100,1187919)
	self:setMoodString(pNpc, "npc_consoling")
	pNpc = spawnMobile(self.planet, "patron_devaronian",60,0.4,0.4,-4.8,72,1187919)
	self:setMoodString(pNpc, "npc_consoling")
	pNpc = spawnMobile(self.planet, "patron_devaronian",60,1.7,0.4,-5.9,21,1187919)
	self:setMoodString(pNpc, "npc_consoling")
	pNpc = spawnMobile(self.planet, "patron_devaronian",60,4.1,0.4,-6.1,-30,1187919)
	self:setMoodString(pNpc, "npc_consoling")
	pNpc = spawnMobile(self.planet, "patron_devaronian",60,5.4,0.4,-4.9,-83,1187919)
	self:setMoodString(pNpc, "npc_consoling")
	pNpc = spawnMobile(self.planet, "patron_devaronian",60,5.5,0.4,-3.2,-107,1187919)
	self:setMoodString(pNpc, "npc_consoling")
	pNpc = spawnMobile(self.planet, "patron_devaronian",60,4.2,0.4,-2.2,-158,1187919)
	self:setMoodString(pNpc, "bored")
	pNpc = spawnMobile(self.planet, "noble",60,-7.4,0.4,-7.4,33,1187919)
	self:setMoodString(pNpc, "npc_standing_drinking")

	--western Tavern E
	pNpc = spawnMobile(self.planet, "businessman",60,5.2,1.0,4.2,7,1187892)
	self:setMoodString(pNpc, "happy")
	pNpc = spawnMobile(self.planet, "medic",60,10.3,0.4,5.6,-152,1187893)
	self:setMoodString(pNpc, "calm")
	pNpc = spawnMobile(self.planet, "surgical_droid_21b",60,10.4,0.4,4.3,-103,1187893)
	self:setMoodString(pNpc, "neutral")
	pNpc = spawnMobile(self.planet, "entertainer",60,2.9,0.4,-6.0,-6,1187893)
	self:setMoodString(pNpc, "entertained")
	pNpc = spawnMobile(self.planet, "patron_chiss",60,2.9,0.4,-2.7,168,1187893)
	self:setMoodString(pNpc, "npc_sitting_ground")
	pNpc = spawnMobile(self.planet, "commoner_tatooine",60,6.4,0.4,-3.0,-132,1187893)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "artisan",60,10.2,0.4,-5.7,90,1187893)
	self:setMoodString(pNpc, "sad")
	pNpc = spawnMobile(self.planet, "farmer_rancher",300,-3.56731,0.408271,-0.572452,135.005,1187893)
	self:setMoodString(pNpc, "npc_consoling")
	pNpc = spawnMobile(self.planet, "bounty_hunter",300,-2.46731,0.408271,-0.572452,180.01,1187893)
	self:setMoodString(pNpc, "npc_accusing")
	pNpc = spawnMobile(self.planet, "rancher",60,-2.46731,0.408271,-1.67245,0,1187893)
	self:setMoodString(pNpc, "worried")

	--large house west A
	pNpc = spawnMobile(self.planet, "commoner_fat",60,-5.1,0.5,-5.0,89,1187999)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "commoner_fat",60,-5.1,0.5,-8.0,89,1187999)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "commoner_fat",60,-3.0,0.5,-9.5,0,1187999)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "judge",60,0,0.5,-9.5,0,1187999)
	self:setMoodString(pNpc, "npc_sitting_table_eating")
	pNpc = spawnMobile(self.planet, "commoner_fat",60,3.0,0.5,-9.5,0,1187999)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "commoner_fat",60,5.1,0.5,-8.0,-89,1187999)
	...
	pNpc = spawnMobile(self.planet, "commoner_fat",60,5.1,0.5,-5.0,-89,1187999)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "entertainer",60,2.3,0.5,-6.0,107,1187999)
	self:setMoodString(pNpc, "entertained")
	pNpc = spawnMobile(self.planet, "entertainer",60,0,0.5,-5.8,175,1187999)
	self:setMoodString(pNpc, "entertained")
	pNpc = spawnMobile(self.planet, "entertainer",60,-2.3,0.5,-6.4,-133,1187999)
	self:setMoodString(pNpc, "entertained")
	pNpc = spawnMobile(self.planet, "entertainer",60,0,0.5,-2.5,160,1187999)
	self:setMoodString(pNpc, "npc_sitting_ground")
	pNpc = spawnMobile(self.planet, "commoner_technician",60,-22.4,1.0,-9.0,-106,1188001)
	self:setMoodString(pNpc, "sad")

	--large house west B
	pNpc = spawnMobile(self.planet, "chiss_male",60,-2.3,1.0,6.7,90,1187871)
	self:setMoodString(pNpc, "npc_sitting_chair")
	...
	--spawnMobile(self.planet, "trainer_architect",0,11,1.133,-14.5,0,1189578)
	...
	self:setMoodString(pNpc, "npc_imperial")
	pNpc = spawnMobile(self.planet, "imperial_cadet",400,9.7,0,-5.9,90,1280131)
	self:setMoodString(pNpc, "npc_imperial")
	pNpc = spawnMobile(self.planet, "imperial_first_lieutenant",400,7.7,0,-7.6,229,1280131)
	self:setMoodString(pNpc, "npc_imperial")
	pNpc = spawnMobile(self.planet, "imperial_private",400,-7.3,0,-3.8,72,1280131)
	self:setMoodString(pNpc, "npc_imperial")
	spawnMobile(self.planet, "imperial_recruiter",0,-0.86,0.4,-8,42,1280131)
	pNpc = spawnMobile(self.planet, "imperial_army_captain",400,-8.8,1,8.7,90,1280132)
	self:setMoodString(pNpc, "npc_imperial")
	pNpc = spawnMobile(self.planet, "imperial_general",400,1.2,1,7.5,315,1280132)
	self:setMoodString(pNpc, "npc_imperial")
	...
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "brawler",300,30.8955,-0.255725,0.957845,360.011,1076968)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "sullustan_male",60,29.7955,-0.255725,2.05785,135.01,1076968)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "medic",300,15.48,-0.255725,6.58106,0,1076966)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "commoner_old",300,15.48,-0.255725,7.68106,180.005,1076966)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "bounty_hunter",300,12.087,0.01,2.23598,360.011,1076961)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "twilek_slave",300,12.087,0.01,3.33598,180.011,1076961)
	self:setMoodString(pNpc, "nervous")
	pNpc = spawnMobile(self.planet, "shamdon_kree",60,-3.61827,0.01,-8.8941,199.448,1076952)
	self:setMoodString(pNpc, "neutral")
	pNpc = spawnMobile(self.planet, "businessman",60,-4.67224,0.0100001,12.0395,0,1076956)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "chiss_male",300,-4.67224,0.01,13.1395,179.996,1076956)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "info_broker",60,-19.4889,0.0100002,1.51058,180.015,1076958)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "businessman",60,-20.5889,0.0100002,1.51058,135.012,1076958)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "scientist",60,-19.4889,0.0100002,0.410576,360.011,1076958)
	self:setMoodString(pNpc, "conversation")

	--Guild Hall/Theater
	pNpc = spawnMobile(self.planet, "bounty_hunter",60,5.07127,2.6,7.75958,180.005,1105851)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "comm_operator",300,-3.43834,2.6,11.8623,357,1105851)
	self:setMoodString(pNpc, "npc_imperial")
	...
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "dede_chesmi",60,26.7839,2.12847,70.8524,180.013,1105853)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "mebi_axane",60,26.7839,2.12876,69.7524,360.011,1105853)
	self:setMoodString(pNpc, "conversation")
	...
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "agriculturalist",60,3247.43,4.00848,-4849.66,180.005,0)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "businessman",60,3532.96,5,-4788.08,313.416,0)
	self:setMoodString(pNpc, "happy")
	spawnMobile(self.planet, "businessman",60,3636.8,5,-4877.95,55.8088,0)
	spawnMobile(self.planet, "businessman",60,3699,5,-4768.14,122.053,0)
	spawnMobile(self.planet, "businessman",60,3698.19,4.91134,-4838.24,31.4813,0)
	spawnMobile(self.planet, "businessman",60,3359.65,5,-4496.04,277.113,0)
	pNpc = spawnMobile(self.planet, "businessman",60,3422.6,5,-4847,300,0)
	self:setMoodString(pNpc, "npc_sitting_table")
	pNpc = spawnMobile(self.planet, "businessman",60,3377.1,5,-4864.9,7,0)
	self:setMoodString(pNpc, "npc_sitting_chair")
	...
	spawnMobile(self.planet, "commoner_tatooine",60,3499.6,5,-5019.9,233.335,0)
	spawnMobile(self.planet, "commoner_tatooine",60,3507.53,5,-5002.63,318.575,0)
	spawnMobile(self.planet, "commoner_tatooine",60,3496.19,5,-4993.49,82.9249,0)
	spawnMobile(self.planet, "commoner_tatooine",60,3347.29,5,-4974.32,230.336,0)
	spawnMobile(self.planet, "commoner_tatooine",60,3379.18,5,-4898.03,283.011,0)
	spawnMobile(self.planet, "commoner_tatooine",60,3316.48,4.96935,-4888.61,231.288,0)
	spawnMobile(self.planet, "commoner_tatooine",60,3732.52,4.00003,-4769.38,321.63,0)
	pNpc = spawnMobile(self.planet, "commoner_tatooine",60,3271.6,5,-4863.7,231,0)
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile(self.planet, "commoner_tatooine",60,3268.3,5,-4854,290,0)
	self:setMoodString(pNpc, "npc_sitting_chair")
	...
	self:setMoodString(pNpc, "worried")
	spawnMobile(self.planet, "criminal",300,3364.26,5,-4854.56,0.24067,0)
	...
	spawnMobile(self.planet, "informant_npc_lvl_1",0,3253,5,-4923,180,0)
	spawnMobile(self.planet, "informant_npc_lvl_1",0,3488,5,-4782,135,0)
	pNpc = spawnMobile(self.planet, "jawa",300,3472.22,5,-4918.59,270.008,0)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "jawa",300,3470.22,5,-4918.59,90.0027,0)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "jawa",300,3471.22,5,-4919.59,0,0)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "jawa",300,3488.01,5,-4884.73,270.008,0)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "jawa",300,3486.01,5,-4884.73,90.0027,0)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "jawa",300,3487.01,5,-4885.73,0,0)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "jawa",300,3739.55,4.3966,-4837.28,269.541,0)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "jawa",300,3737.55,4.03113,-4837.28,90.4693,0)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "jawa",300,3738.55,4.29151,-4838.28,35.3182,0)
	self:setMoodString(pNpc, "conversation")
	spawnMobile(self.planet, "jawa",300,3475.25,4.93605,-4852.73,96.6921,0)
	spawnMobile(self.planet, "jawa",300,3451.49,4.87154,-4524.17,186.748,0)
	spawnMobile(self.planet, "jawa",300,3654.1,5,-4784.9,150,0)
	spawnMobile(self.planet, "jawa",300,3655.6,5,-4785,-116,0)
	spawnMobile(self.planet, "jawa",300,3654.8,5,-4786.2,-25,0)
	pNpc = spawnMobile(self.planet, "jawa_engineer",300,3661.1,5,-4748.9,230,0)
	self:setMoodString(pNpc, "npc_use_terminal_high")
	spawnMobile(self.planet, "jawa_henchman",300,3663,5,-4858.6,348,0)
	spawnMobile(self.planet, "jawa_henchman",300,3658,5,-4748.7,135,0)
	spawnMobile(self.planet, "jawa_smuggler",300,3469.3,4.13017,-4861.5,354.361,0)
	spawnMobile(self.planet, "jawa_thief",300,3425.73,4.00067,-4907.72,217.107,0)
	spawnMobile(self.planet, "jawa_thief",300,3655.3,5,-4801.2,118,0)
	spawnMobile(self.planet, "jawa_thief",300,3658.7,5,-4801.1,-155,0)
	pNpc = spawnMobile(self.planet, "jawa_warlord",300,3450.7,0,-4526.2,20,0)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "jawa_warlord",300,3663.3,5,-4856,143,0)
	...
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "scavenger",300,3248.76,4.9251,-4842.99,3.29811,0)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "scavenger",300,3356.9,5,-4780,56,0)
	self:setMoodString(pNpc, "npc_sitting_table")
	...
	pNpc = spawnMobile(self.planet, "settler",300,3420.74,5,-5007.61,2.42392,0)
	self:setMoodString(pNpc, "conversation")
	...
	self:setMoodString(pNpc, "npc_sitting_chair")
	--spawnMobile(self.planet, "trainer_entertainer",0,3477.89,5,-4791.6,215,0)
	spawnMobile(self.planet, "trainer_marksman",0,3506,5,-4760,180,0)
	spawnMobile(self.planet, "trainer_marksman",0,3552,5,-4710,215,0)
	spawnMobile(self.planet, "trainer_medic",0,3522,5,-4774,200,0)
	--spawnMobile(self.planet, "trainer_musician",0,3393,5,-4791,300,0)
