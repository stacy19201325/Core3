...
--		{templateFile = "object/tangible/veteran_reward/harvester.iff", milestone=90, oneTime=true, description="@veteran_new:poweredharvester"},
		...
		{templateFile = "object/tangible/deed/vehicle_deed/barc_speeder_deed.iff", milestone=360, oneTime=true, description="A BARC Speeder"},
...
--		{templateFile = "object/tangible/veteran_reward/antidecay.iff", milestone=360, oneTime=true, description="@veteran_new:antidecay"},
		...
		{templateFile = "object/tangible/deed/vehicle_deed/barc_speeder_deed.iff", milestone=900, oneTime=true, description="A BARC Speeder"},
